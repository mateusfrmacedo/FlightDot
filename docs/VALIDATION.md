...
- O touch segue a leitura direta do Demo V3 da Waveshare: contador em `0x02`, coordenadas em `0x03..0x06`, I²C a 300 kHz e polling LVGL a cada 10 ms. A interface não muda de tela por swipe; um gesto horizontal só abre/fecha o menu de zoom.
